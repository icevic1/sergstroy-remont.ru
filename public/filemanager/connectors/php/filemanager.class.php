...
//		substr(realpath($path) . DIRECTORY_SEPARATOR, 0, strlen($this->path_to_files)) == (realpath($this->path_to_files) . DIRECTORY_SEPARATOR)

//		var_dump($current_path, '------',substr(realpath($current_path) . DIRECTORY_SEPARATOR, 0, strlen($this->path_to_files)), '------', (realpath($this->path_to_files) . DIRECTORY_SEPARATOR));die;
