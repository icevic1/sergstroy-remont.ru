...
class Site_Settings extends Admin_Controller
{
	...
	function index()
	{
		...
		$data['loadedItem'] = $this->SiteSettings->get();

//		 		var_dump($data['siteSettings']);die;
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {

            $inputData = $this->input->post('loadedSettings');
...
// 				var_dump($inputData);die;
		...
		$data['CONTENT']='admin/site_settings/edit';
