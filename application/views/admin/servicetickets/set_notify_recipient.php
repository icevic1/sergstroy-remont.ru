<div class="box no-margin">
    ...
    <div class="box-content">
		...
		<input type="hidden" name="OldNotifyID" value="<?php echo set_value('OldNotifyID', ((isset($loadedItem['NotifyID']))? $loadedItem['NotifyID']: ''))?>" />
	    <div class="cust-holder no-margin">
	    	<h3 class="box-hd">Notification</h3>
	    	<div class="box-content-no">
	    		<table class="cust-inputs">
	    			<tr><td class="input-label required">Notification Type</td><td class="input-field"><?php echo form_dropdown('NotifyID', $notifyList, $default = ((isset($loadedItem['NotifyID']))? $loadedItem['NotifyID'] : 0), 'id="NotifyID"');?></td><td><?php echo form_error('NotifyID'); ?></td></tr>
	    			<tr><td class="input-label required">Recipients</td><td class="input-field"><?php echo form_dropdown('roles[]', $roles, $default = ((isset($loadedItem['roles']))? $loadedItem['roles']:''), 'id="role_id" multiple="multiple"');?></td><td><?php echo form_error('roles[]'); ?></td></tr>
	    		</table>
	    	</div>
	    </div>
