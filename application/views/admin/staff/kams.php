<div class="box no-margin">
    <div class="box-header well">
        ...
        <div class="box-icon">
            ...
            <a href="<?php echo base_url('admin/staff/save_kam/')?>" class="btn-link"><i class="cus-add"></i> New CSR</a>
            <?php }else{?>
            <a class="btn disabled" href="" ><i class="cus-add"></i> New CSR</a>
            <?php }?>
        </div>
        <div class="box-icon">
          ...
          <?php if (isset($filteredUsers)) {?>
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <a class="btn-link" href="<?php echo site_url('admin/staff/save_kam/'.$item->user_id)?>"><i class="cus-page-white-edit"></i>Edit</a>
                    <?php }else{?>
