	    ...
	    <div class="cust-holder">
	    	...
	    	<div class="box-content-no">
	    		<table class="cust-inputs">
	    			...
	    			<tr><td class="input-label">Mobile No.</td><td class="input-field"><input id="mobile_no" name="user[mobile_no]" type="text" value="<?php echo set_value('user[mobile_no]', ((isset($loadedItem['mobile_no']))? $loadedItem['mobile_no']:'')); ?>" maxlength="64" /></td><td><?php echo form_error('user[mobile_no]'); ?></td></tr>
	    			...
	    			<tr><td class="input-label">Role</td><td class="input-field"><?php echo form_dropdown('roles[]', $roles = array_replace(array(''=>'...'), Acl::simpleRoleArray()), $default = ((isset($loadedRoles))? $loadedRoles:''), 'id="role_id" multiple="multiple"');?></td><td><?php echo form_error('roles[]'); ?></td></tr>
