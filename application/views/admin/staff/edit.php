	    ...
	    <div class="cust-holder">
	    	...
	    	<div class="box-content-no">
	    		<table class="cust-inputs">
	    			...
	    			<tr><td class="input-label">Email</td><td class="input-field"><input id="email" name="user[email]" type="text" value="<?php echo set_value('user[email]', ((isset($loadedItem['email']))? $loadedItem['email']:'')); ?>" maxlength="128" /></td><td><?php echo form_error('user[email]'); ?></td></tr>
