<div class="box">
    ...
    <div class="box-content">
    	<p><?php if( !empty($this->form_validation->error_array())) foreach ($this->form_validation->error_array() as $errorItem) echo '<br /><font color="red"> - '.$errorItem. '</font>'; 
          ...
          <?php echo form_open(base_url('admin/customeracl/permissionEdit/'. ((isset($permission->permission_id))? $permission->permission_id : '')), array('id'=>'frm_editpermission','name'=>'frm_editpermission','class'=>'form-horizontal')); ?>
            ...
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
               		<input type="checkbox" id="per_read" name="read" value="1" <?php echo set_checkbox('read', '1', ((isset($permission->read_access) && $permission->read_access > 0)? true : false)); ?> />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for=""per_write"">Write access</label>
                <div class="controls">
                	<input type="checkbox" id="per_write" name="write" value="1" <?php echo set_checkbox('write', '1', ((isset($permission->write_access) && $permission->write_access > 0)? true : false)); ?> />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="per_modify">Modify access</label>
                <div class="controls">
                	<input type="checkbox" id="per_modify" name="modify" value="1" <?php echo set_checkbox('modify', '1', ((isset($permission->modify_access) && $permission->modify_access > 0)? true : false)); ?> />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label" for="per_delete">Delete access</label>
                <div class="controls">
                	<input type="checkbox" id="per_delete" name="delete" value="1" <?php echo set_checkbox('delete', '1', ((isset($permission->delete_access) && $permission->delete_access > 0)? true : false)); ?> />
                </div>
              </div>
               <div class="control-group">
