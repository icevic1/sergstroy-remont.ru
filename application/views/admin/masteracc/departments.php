<div class="box">
    <div class="box-header well" data-original-title>
        ...
        <div class="box-icon">
            ...
            <a href="<?php echo base_url('admin/masteracc/saveDepartment/')?>" class="btn" style="width:50px"><i class="cus-add"></i> Add</a>
            <?php }else{?>
    ...
    <div class="box-content">
        <table class="table table-striped table-bordered bootstrap-datatable datatable">
          ...
          <tbody>
            ...
            <tr>
                <td style="width: 20px;"><?php echo $item->dep_id;?></td>
                <td class="center"><?php echo $item->dep_name;?></td>
                ...
                <td class="center" style="width: 150px;">
                    ...
                    <a class="btn" href="<?php echo base_url('admin/masteracc/saveDepartment/'.$item->dep_id)?>">
                    ...
                    <a class="btn" href="<?php echo base_url('admin/masteracc/deleteDepartment/'.$item->dep_id)?>" onclick="return confirm('You are sure to delete this record')">
