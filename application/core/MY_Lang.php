...
//     var $languages=array('ru' => 'russian');
    var $languages = array('en' => 'english');
	...
	function __construct()
	{
		...
		if($db){
			...
			$res = $db->get('sc_language')->result();

			foreach($res as $row){
				$this->languages[$row->l_short_name] = $row->l_name;
			}
		} */
	...
	function lang()
	{
		...
		$lang = array_search(strtolower($language), array_map('strtolower', $this->languages), false);
