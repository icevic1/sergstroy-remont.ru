...
class nusoap_server extends nusoap_base {
    ...
    */
    function configureWSDL($serviceName,$namespace = false,$endpoint = false,$style='document', $transport = 'http://schemas.xmlsoap.org/soap/http', $schemaTargetNamespace = false)
    {
    	global $HTTP_SERVER_VARS;
